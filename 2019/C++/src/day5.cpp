...
------------------------------------------------------------------------------*/
/**
 * \fn int processInputs(std::vector<long long> inputs, int input, bool debug=false)
 ...
 */
int processInputs(std::vector<long long> inputs, int input, bool debug=false) {
  // create program
...
void makeTests() {
  // Part I + II
  std::vector<long long> inputs1 = { 3,0,4,0,99 };
  assert(processInputs(inputs1, 1) == 1);
  std::vector<long long> inputs2 = { 3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9 };
  assert(processInputs(inputs2, 0) == 0);
  assert(processInputs(inputs2, 1) == 1);
  std::vector<long long> inputs3 = { 3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,
